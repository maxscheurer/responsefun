...
panor_terms = sos_panor(state, 0.5, 0.6, 0.7)
antonia_terms = sos_antonia(state, 0.5, 0.6, 0.7)
print(panor_terms)
print(antonia_terms)
np.testing.assert_allclose(panor_terms, antonia_terms, atol=1e-7)
#sos = sos_panor_single(state, 0.5, 0.6, 0.7)
#isr = isr_panor_single(state, 0.5, 0.6, 0.7)
#print(sos)
#print(isr)
